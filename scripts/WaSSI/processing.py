...
for year in years:
    for month in months:
        ...
        arcpy.Clip_management(raster, bounds, 'ppt_{}{}'.format(
            year, month), la_shapefile, PRISM_NaN, "ClippingGeometry", "NO_MAINTAIN_EXTENT")
        ...
        array = arcpy.RasterToNumPyArray(tr)
